...
// 	}
	...
	if(cmd === `${prefix}nickname` && message.channel.id != "486026246007029781") {
	...
	if(cmd === `${prefix}rankme` && message.channel.id === "486681158348701697"){
		...
		if(!username) return message.reply("¡Establezca un apodo fortnite CORRECTO! O haga**!helpme**").then(msg => msg.delete(2000));
 ...
 //	scrimlast3chan.send(startingEmbed);
	...
	const allCodeRoles = message.guild.roles
		...
		for(const codeRoles of splitCodeRoles) {
			...
			for(const role of codeRoles) {
				const membersString = role.members.map(m => message.member.nickname).join("\n");
...
//}
	...
	return;	
 	...
 	if(cmd === `${prefix}hacked` && message.channel.id != "486026246007029781") {
	...
	if(message.channel.id === "486681158348701697") return;
 	if(message.channel.id === "486681135619899412") return;
 	if(message.channel.id === "486026203350958081") return;
	...
	if(args[0] != "lifetime" && args[0] != "solo" && args[0] != "duo" && args[0] != "squad") return message.reply("Format !fn <solo,duo,squad,lifetime> <username>");	
		...
		let data = fortnite.user(username, platform).then(data => {
			...
			if(gamemode === `solo`) {
				...
				message.reply("Your rank is set based on **SQUAD** stats.");
...
//	return;
//}
 	if(cmd === `${prefix}invite` && message.channel.id != "486026246007029781") {
		if(message.channel.id === "486681135619899412") return;
		if(message.channel.id === "486681158348701697") return;
	...
	return;
 	...
 	if(cmd === `${prefix}help` && message.channel.id != "486026246007029781") {
			if(message.channel.id === "486681135619899412") return;
		if(message.channel.id === "486681158348701697") return;
...
//}
 	...
 	if(cmd === `${prefix}report` && message.channel.id != "486026246007029781"){
			if(message.channel.id === "486681135619899412") return;
		if(message.channel.id === "486681158348701697") return;
	...
	reportschannel.send(reportEmbed);
 	...
 	if(cmd === `${prefix}info` && message.channel.id != "486026246007029781") {
		if(message.channel.id === "486681135619899412") return;
		if(message.channel.id === "486681158348701697") return;
...
// 	if(cmd === `${prefix}dead` && message.channel.id === "486026246007029781"){
// 	message.member.addRole(message.guild.roles.find(r => r.name === "Dead"));
// 	let members = [];
// 	message.guild.roles.find(r => r.name === "Dead").members.forEach(member =>{
// 		members.push(member.tag)
...
// 	}
 	...
 	if(cmd === `${prefix}botinfo` && message.channel.id != "486026246007029781"){
				if(message.channel.id === "486681135619899412") return;
		if(message.channel.id === "486681158348701697") return;
